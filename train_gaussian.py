...
if 'mnist' in args.dataset : 
    ...
    loss_op   = lambda real, nn_out : gaussian_loss_1d(real, nn_out)
    sample_op = lambda nn_out : sample_from_gaussian_1d(nn_out)
...
model = PixelCNN(nr_resnet=args.nr_resnet, nr_filters=args.nr_filters, 
            input_channels=input_channels, nr_logistic_mix=args.nr_logistic_mix, gauss_out=True)
model = model.cuda()
